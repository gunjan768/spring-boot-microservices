...
public class SpringDemoApplication {
	...
	public static void main(String[] args) {
		...
		// run() method returns the 'ConfigurableApplicationContext' object. Here (run() method) spring container is initialized that here
...
// . Dependency management: Use version of parent only, spring-boot-starter-* dependencies inherit version from parent.
